...
import {Ciudad, HistoriaMedica, Mascota, MascotaRelations, Raza, SolicitudAdopcion, Vacuna, VacunaMascota} from '../models';
...
import {VacunaRepository} from './vacunas.repository';
...
> {
  ...
  public readonly solicitudesDeAdopcion: HasManyRepositoryFactory<SolicitudAdopcion, typeof Mascota.prototype.id>;
